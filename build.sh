...
i586-elf-gcc -T link-bran.ld -o xitox.kern -ffreestanding -O2 -nostdlib boot.o kernel.o scrn.o kb.o gdt.o idt.o irq.o isrs.o  timer.o -lgcc
#linker.ld
